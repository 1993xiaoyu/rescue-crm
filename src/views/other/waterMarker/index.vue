  ...
  <div class="m-water-marker">
    ...
    <el-descriptions title="配置项 " :column="1" border class="descriptions">
      ...
      <el-descriptions-item label="container">
        水印容器，默认生成在 document.body 下面
      </el-descriptions-item>
      <el-descriptions-item label="globalAlpha">
        设置图形和图像透明度的值，默认为 0.3
      </el-descriptions-item>
      ...
      <el-descriptions-item label="rotate">
        文字旋转角度，默认为 '16' 计算方式为 (Math.PI * rotate) / 180
      </el-descriptions-item>
      <el-descriptions-item label="iconStyle">
        图标的样式，默认样式为 { width: "1em", height: " 1em" }
      </el-descriptions-item>
    </el-descriptions>
  </div>
</template>
