<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="ruleForm" label-width="150px" status-icon :inline="true">
      ...
      <el-form-item label="品牌" prop="pinPai" required :show-message="false">
        <el-input v-model="ruleForm.pinPai" />
      </el-form-item>
      <el-form-item label="保修时间" prop="warranty" required :show-message="false">
        <el-date-picker
      ...
      <el-form-item label="电池状态" prop="batteryStatus" required :show-message="false">
      ...
      <el-form-item label="电极片状态" prop="electrodeStatus" required :show-message="false">
      ...
      <el-form-item label="所属街道" prop="stree" required :show-message="false">
        <el-input v-model="ruleForm.stree" />
      </el-form-item>

      <el-form-item label="所属社区" prop="community" required :show-message="false">
        <el-input v-model="ruleForm.community" />
      </el-form-item>
      <el-form-item label="安装厂商" prop="manufacturer" required :show-message="false">
      ...
      <el-form-item label="资金来源" prop="capital" required :show-message="false">
      ...
      <el-form-item label="设备管理员" prop="manager" required :show-message="false">
        <el-input v-model="ruleForm.manager" />
      </el-form-item>
      <el-form-item label="管理员手机" prop="managerPhone" required :show-message="false">
        <el-input v-model="ruleForm.managerPhone" />
      </el-form-item>
      <el-form-item label="管理单位座机" prop="managerTel" required :show-message="false">
