<template>
  <el-dialog v-model="dialogVisible" title="批量导入志愿者" width="40%" class="upload-dialog">
    <div class="upload-content">
      <div class="upload-content__item">
        ...
        <div>
          ...
          <el-button @click="handleImportTemplate">下载模板</el-button>
        </div>
      </div>
      <div class="upload-content__item">
        ...
        <div>
          ...
          <div class="upload-content__tip"> 请将完善后的表格上传，上传成功后设备即新增成功。 </div>
...
<script setup>
  ...
  import { importTemplate } from '@/api/volunteer.ts'
